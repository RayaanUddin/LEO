...
Config.DeathTime = 250 -- How long the timer is for players to bleed out completely and respawn at the hospital
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(311.75, -592.74, 43.28),
	    --[2] = vector3(1769.04, 2571.05, 45.63), -- paleto
        --[3] = vector3(1769.04, 2571.05, 45.63) -- prison
    },
    ["duty"] = {
        [1] = vector3(310.41, -602.88, 43.28),
        [2] = vector3(-254.88, 6324.5, 32.58),
        [3] = vector3(-1865.46, -322.21, 49.45),
    },
    ["vehicle"] = {
        [1] = vector4(294.578, -574.761, 43.179, 35.79),
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
        [3] = vector3(-1841.78, -320.6, 49.14),

    },
    ["helicopter"] = {
        [1] = vector4(351.58, -587.45, 74.16, 160.5),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
        [3] = vector4(-1867.21, -352.42, 58.03, 158.34),
    },
    ["armory"] = {
        [1] = vector3(306.75, -601.91, 43.28),
        [2] = vector3(-245.13, 6315.71, 32.82),
        [3] = vector3(-1865.01, -326.07, 49.45), 
    },
    ["roof"] = {
        [1] = vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(332.42, -595.64, 43.28),
    },
    ["stash"] = {
        [1] = vector3(301.69, -600.15, 43.28),
        [2] = vector3(-1874.75, -305.18, 49.47),
    },
     ["beds"] = {
    ...
    ["jailbeds"] = {
        [1] = {coords = vector4(1771.85, 2598.08, 46.66, 87.97), taken = false, model = 2117668672},
        [2] = {coords = vector4(1771.7, 2594.88, 46.66, 81.66), taken = false, model = 2117668672},
        [3] = {coords = vector4(1762.09, 2594.55, 46.66, 276.15), taken = false, model = 2117668672},
        [4] = {coords = vector4(1762.01, 2597.49, 46.66, 276.42), taken = false, model = 2117668672},
    },
    ["stations"] = {
...
Config.AuthorizedVehicles = { -- Vehicles players can use based on their ambulance job grade level
	-- Grade 0
	[0] = {
		["lsambulance"] = "Ambulance1",
        ["ambulance22"] = "Ambulance2",
        ["ems"] = "Dodge Charger",
	},
	-- Grade 1
	[1] = {
