...
function OnDeath()
    if not isDead then
        ...
        if isDead then
            ...
            -- TriggerServerEvent('hospital:server:ambulanceAlert', Lang:t('info.civ_died'))    -- Original, commented out for ps-dispatch/ps-mdt to work.
            exports['ps-dispatch']:InjuriedPerson()  -- added for ps-dispatch/ps-mdt
        end
    end
end
